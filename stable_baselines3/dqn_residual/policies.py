...
class ResidualSoftQNetwork(QNetwork):
    ...
    def _predict(self, observation: PyTorchObs, prior_logprob: PyTorchObs, deterministic: bool = False) -> th.Tensor:
...
class ResidualSoftDQNPolicy(DQNPolicy):
    ...
    def make_q_net(self) -> ResidualSoftQNetwork:
        ...
        net_args['ignore_prior'] = self.ignore_prior
    ...
    def action_distribution(self, obs):
        ...
        with th.no_grad():
            ...
            if self.ignore_prior: # ignore prior_logprob
                ...
                q_values = self.q_net(obs) + prior_logprob
